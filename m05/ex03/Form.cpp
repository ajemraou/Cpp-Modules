...
/*   Updated: 2023/01/31 13:02:50 by ajemraou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (_signed == false || executor.getGrade() > _execute)
		throw (GradeTooLowException());
}
...
void		Form::set_signed( const bool status)
{
	_signed = status;
}
...
{
	return ("grades is too high!");
}
const char* Form::GradeTooLowException::what() const throw()
{
	return ("grades is too low!");
}
